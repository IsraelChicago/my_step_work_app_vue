  ...
  <div class="tenth-step-show">
    <div class="container">
      ...
      <div id="fifth-column-show">
        ...
        <router-link  v-bind:to="'/tenth_step/' + fourthStep.id + '/edit'">
          <button class="button-input">Edit this Tenth Step</button>
        </router-link>
        <br>
        <br>
        <router-link  v-bind:to="'/tenth_step'">
          <button class="button-input">Back to all tenth steps page</button>
        </router-link>
