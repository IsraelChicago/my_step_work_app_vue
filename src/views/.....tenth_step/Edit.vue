        ...
        <div>
              ...
              <div class="type-of-fourth" v-if="!fourthStep.type_done ">
                ...
                <h3>
                  ...
                  <div v-if="fourthStep.tenth_step">
                    <h1>
                    Tenth Step </h1>
            ...
            <div v-if="fourthStep.type_done">
                ...
                <section id="three-columns-a">
                  ...
                  <div v-if="fourthStep.resentment ">
                    ...
                    <input class="text-input" type="text" placeholder="Which person, place, thing, situation, or organization am I resenting?" v-model=" fourthStep.who"></input>
                  </div>
                  ...
                  <div v-if="fourthStep.harm">
                    ...
                    <label><strong>Who</strong></label><br>
                    <input class="text-input" type="text" placeholder="Which person, place, thing, or organization did I harm?" v-model=" fourthStep.who"></input>
                  </div>
                  ...
                  <div v-if="fourthStep.fear">
                    ...
                    <input class="text-input" type="text" placeholder="Which person, place, thing, situation, or organization am I afraid of?" v-model=" fourthStep.what"></input>
                  </div>
                </section>  
                ...
                <section id="three-columns-b">
                    ...
                    <div v-if="fourthStep.resentment ">
                      ...
                      <label><strong>What</strong></label><br>
                      <input placeholder="What am I resentful about?:" v-model="fourthStep.what"> </input>
                    </div>
                    <br>
                    ...
                    <div v-if="fourthStep.harm">
                      ...
                      <label><strong>What</strong></label><br>
                      <input placeholder="What specifically are the details about, how I harmed?:" v-model="fourthStep.what"> </input>
                    </div>
                    <br>
                    ...
                    <div v-if="fourthStep.fear">
                      ...
                      <input placeholder="Detail out on all levels, even the darkest scenario possible!:" v-model="fourthStep.why"> </input>
                    </div>
                    <br>
            ...
            <div v-if="fourthStep.three_columns_done">
              ...
              <div id=fourth-column>
                ...
                <div>
                  ...
                  <input placeholder="Dig deep where was I selfish, no matter on anyone else:" v-model="fourthStep.selfish"> </input>
                </div>
                <br>

                <div>
                  <label>Where was I dishonest?</label><br>
                  <input placeholder="Dig deep where and how was I dishonest, no matter on anyone else:" v-model="fourthStep.dishonest"> </input>
                </div>
                <br>

                <div>
                  <label>Where was I self seeking?</label><br>
                  <input placeholder="Dig deep where was I self seeking, I should get something out, no matter on anyone else:" v-model="fourthStep.self_seeking"> </input>
                </div>
                <br>

                <div>
                  <label>Where was I Frightened?</label><br>
                  <input placeholder="Dig deep where was I acting out of fear, what was I afraid will happen if I let go?:" v-model="fourthStep.frightened"> </input>
                </div>
                <br>
              </div>
              ...
              <div v-if="fourthStep.fear "id:="for-fear-only">
                ...
                <div>
                  ...
                  <input  placeholder="Explain the pros and cons that fear did to you towards something like this in the past:"v-model="fourthStep.fear_solved"> </input>
                </div>
                <br>
              </div>
            ...
            <div id="fifth-column" v-if="fourthStep.fourth_column_done">
              ...
              <div>
                ...
                <input placeholder="PUTS:" v-model="fourthStep.selfless"> </input>
              </div>
              <br>

              <div>
                <label>How can I now be Rigorous Honest? <br>(opposite of dishonest) </label><br>
                <input placeholder="PUTS:" v-model="fourthStep.rigorous_honesty"> </input>
              </div>
              <br>

              <div>
                <label>How can I now be "HP seeking"? <br>(opposite of self seeking) </label><br>
                <input placeholder="PUTS:" v-model="fourthStep.hp_seeking"> </input>
              </div>
              <br>

              <div>
                <label>How can I now be settled in the hands of my HP? <br> (opposite of fear) </label><br>
                <input placeholder="PUTS:" v-model="fourthStep.hp_serenity"> </input>
              </div>
              <br>
  ...
  methods: {
    submit: function() {
      var params = {
        ...
        tenth_step: this.fourthStep.tenth_step,
      ...
      axios.patch("/api/fourth_steps/" + this.fourthStep.id, params).then(response => {
        ...
        this.$router.push("/tenth_step/" + this.fourthStep.id);
      }).catch(error => {
